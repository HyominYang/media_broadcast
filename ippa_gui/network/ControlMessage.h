...
#ifndef GSTREAMER_PRATICE_IPPA_SERVER_CONTROLMESSAGE_H_
#define GSTREAMER_PRATICE_IPPA_SERVER_CONTROLMESSAGE_H_
...
#endif //GSTREAMER_PRATICE_IPPA_SERVER_CONTROLMESSAGE_H_
